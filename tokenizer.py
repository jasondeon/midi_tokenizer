...
def main():
    # Use-case 
    filename = 'test.mid'
    seq = mid2dat_anna(filename) # returns list of MidiToken objects given a MIDI file
    print([(t.type, t.value) for t in seq[:20]])
    dat2mid_anna(seq, 'test_out.mid') # writes a MIDI file given a list of MidiToken's
